...
Which is enough to solve the 3 problems we had:
...
This is the most basic idea behind the term SSR and with this in mind, we can create complex and powerful mechanisms:
...
The following diagram is one of the mental representations I'm using to determine when I would consider using a technic over another one. It's not a source a truth at all. 
