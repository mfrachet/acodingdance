...
####  Do we need server side rendering in our application?

I'm sharing down one of the mental representation I rely on when I have to make a choice when starting to build an application. But remember, everything is a matter of tradeoffs. You will have pros and cons with any of the following system.
